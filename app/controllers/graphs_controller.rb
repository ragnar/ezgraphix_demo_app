class GraphsController < ApplicationController
  ...
  def ms_stackedcolumn2dlinedy
    ...
    @ds << Ezgraphix::Data::Set.new( 10 )
    @ds << Ezgraphix::Data::Set.new( 20 )
    @ds << Ezgraphix::Data::Set.new( 30 )
    @ds << Ezgraphix::Data::Set.new( 23 )
    @ds << Ezgraphix::Data::Set.new( 13 )
    @ds << Ezgraphix::Data::Set.new( 27 )
    @ds << Ezgraphix::Data::Set.new( 30 )
    @dds << @ds

    @ds = Ezgraphix::Data::Dataset.new( :seriesName => "Unubscribe", :include_root => true )
    @ds << Ezgraphix::Data::Set.new( -8 )
    @ds << Ezgraphix::Data::Set.new( -20 )
    @ds << Ezgraphix::Data::Set.new( -10 )
    @ds << Ezgraphix::Data::Set.new( -3 )
    @ds << Ezgraphix::Data::Set.new( -8 )
    @ds << Ezgraphix::Data::Set.new( -13 )
    @ds << Ezgraphix::Data::Set.new( -2 )

    @dds << @ds
    @graph.add_dataset( @dds )

    @ls = Ezgraphix::Data::Lineset.new( :seriesName => "Total subscribers")
    @ls << Ezgraphix::Data::Set.new( 15 )
    @ls << Ezgraphix::Data::Set.new( 35 )
    @ls << Ezgraphix::Data::Set.new( 45 )
    @ls << Ezgraphix::Data::Set.new( 33 )
    @ls << Ezgraphix::Data::Set.new( 27 )
    @ls << Ezgraphix::Data::Set.new( 35 )
    @ls << Ezgraphix::Data::Set.new( 15 )
    @graph.add_lineset( @ls )

    @ls = Ezgraphix::Data::Lineset.new( :seriesName => "Total revenue")
    @ls << Ezgraphix::Data::Set.new( 17 )
    @ls << Ezgraphix::Data::Set.new( 37 )
    @ls << Ezgraphix::Data::Set.new( 47 )
    @ls << Ezgraphix::Data::Set.new( 35 )
    @ls << Ezgraphix::Data::Set.new( 30 )
    @ls << Ezgraphix::Data::Set.new( 37 )
    @ls << Ezgraphix::Data::Set.new( 17 )
    @graph.add_lineset( @ls )

    @graph.add_categories( ["2003","2004","2005","2006","2007", "2008", "2009"])
